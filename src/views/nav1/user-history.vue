...
<section>
    ...
    <el-table :height="totalCount==0 ? 0 : tableHeight "  :data="dataList" v-loading="dataListLoading"  style="width:100%">
        ...
        <el-table-column prop="objectName" label="频道" width="140">
        </el-table-column>
        <el-table-column prop="lastProgramName" label="节目" width="300">
        </el-table-column>
        <el-table-column prop="seconds" label="观看时长" width="120" >
        </el-table-column>
        <el-table-column prop="totalTime" label="节目时长" min-width="180" >
        </el-table-column>
    </el-table>
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
    <!-- 分页插件 -->
